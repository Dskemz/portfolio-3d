...
export default function TechBreakdownSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="w-full py-16 md:py-20 px-6 md:px-12 lg:px-20 bg-gradient-to-b from-black to-slate-900"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <p className="text-sm md:text-base text-slate-300 font-light max-w-3xl">
            Décomposition du processus de rendu et de la topologie 3D.
          </p>
        </div>
        ...
        <div className="mt-12 md:mt-16 bg-slate-800 rounded-lg p-6 md:p-8">
