          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
            <div>
              <p className="text-base md:text-lg text-slate-300 font-light leading-relaxed max-w-2xl">
                Création de perspectives 3D photoréalistes pour la présentation de collections de
                mobilier de salle de bain, fidélité des matériaux, étude d&apos;éclairage,
                optimisation du maillage pour déclinaison temps réel.
              </p>
            </div>
      ...
      <div className="px-6 md:px-12 lg:px-20 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="text-xs text-slate-400 hover:text-white font-light transition-colors">
              Accueil
            </Link>
            <Link href="/portfolio" className="text-xs text-slate-400 hover:text-white font-light transition-colors">
              Portfolio
            </Link>
            <Link href="/services" className="text-xs text-slate-400 hover:text-white font-light transition-colors">
              Services
            </Link>
            <Link href="/contact" className="text-xs text-slate-400 hover:text-white font-light transition-colors">
              Contact
            </Link>
          </div>
        </div>
