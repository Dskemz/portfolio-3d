      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={textRef} className="mb-16 md:mb-20 max-w-3xl">
          <div className="mb-4 flex items-center gap-3">
            <span className="text-xs font-light text-rose-300 uppercase tracking-widest">01</span>
            <span className="h-px w-12 bg-rose-300/50" />
            <span className="text-xs font-light text-rose-200 uppercase tracking-widest">Pièce d&apos;exception</span>
          </div>
