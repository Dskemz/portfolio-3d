...
export default function PhraseSection({ children }: PhraseSectionProps) {
  return (
    <section className="w-full bg-black px-6 md:px-12 lg:px-20 py-20 md:py-28">
      <p className="max-w-4xl mx-auto text-center text-2xl md:text-3xl lg:text-4xl font-light text-white leading-tight">
        {children}
      </p>
    </section>
  );
