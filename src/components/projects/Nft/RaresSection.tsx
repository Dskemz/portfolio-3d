      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={textRef} className="mb-16 md:mb-20 max-w-3xl">
          <div className="mb-4 flex items-center gap-3">
            <span className="text-xs font-light text-purple-400 uppercase tracking-widest">03</span>
            <span className="h-px w-12 bg-purple-400/50" />
            <span className="text-xs font-light text-purple-300 uppercase tracking-widest">Rareté élevée</span>
          </div>
