          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12 mb-20">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Modélisation 3D', 'Texturing', 'Packshots', 'Vidéos 360°'].map(
                  (skill) => (
                    <span
                      key={skill}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
            <div>
              <p className="text-base md:text-lg text-slate-300 font-light leading-relaxed max-w-2xl">
                Création 3D complète de la gamme de montres connectées Withings :
                modélisation des boîtiers, cadrans et bracelets, mise en scène
                studio, vidéos 360° pour le shop interactif et packshots pour la
                grande distribution.
              </p>
            </div>
