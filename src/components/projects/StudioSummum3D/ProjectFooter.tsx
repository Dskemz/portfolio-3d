          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12 mb-20">
            <div>
              ...
              <p className="text-sm text-slate-400 font-light mt-2">
                Sauvegarde Numérique du Patrimoine
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Photogrammétrie', 'Retopologie', 'GLTF/GLB', 'WebGL'].map(
                  (skill) => (
                    <span
                      key={skill}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
            <div>
              <p className="text-base md:text-lg text-slate-300 font-light leading-relaxed max-w-2xl">
                ...
                nettoyage, retopologie et optimisation pour une exploitation
                fluide en temps réel — musées virtuels, WebGL et archives
                numériques.
              </p>
            </div>
