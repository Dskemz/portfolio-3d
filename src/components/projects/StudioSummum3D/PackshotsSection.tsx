...
const PACKSHOTS_DATA: Packshot[] = [
  {
    id: 1,
    variant: 'Showroom Virtuel',
    description: 'Intégration WebGL',
    image: '/images/projets/summum-3d/12-showroom-1.svg',
  },
  {
    id: 2,
    variant: 'Musée Virtuel',
    description: 'Environnement immersif',
    image: '/images/projets/summum-3d/13-showroom-2.svg',
  },
  {
    id: 3,
    variant: 'Vue Fiche Œuvre',
    description: 'Détail interactif',
    image: '/images/projets/summum-3d/14-showroom-3.svg',
  },
  {
    id: 4,
    variant: 'Configurateur',
    description: 'Rotation & zoom temps réel',
    image: '/images/projets/summum-3d/15-showroom-4.svg',
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-14 text-center">
          <h2 className="text-3xl md:text-4xl font-light text-white mb-4">
            Application Showroom & WebGL
          </h2>
          <p className="text-sm md:text-base text-slate-300 font-light max-w-2xl mx-auto">
            Livraison de fichiers 3D légers et robustes, prêts pour
            l'intégration dans des environnements interactifs et musées
            virtuels.
          </p>
        </div>
