    ...
    >
      ...
      >
        ...
        <p className="max-w-2xl text-sm md:text-base text-neutral-300 font-light leading-relaxed">
          Étude de cas sur la numérisation haute fidélité d'œuvres d'art par
          photogrammétrie, suivie d'un travail de retopologie et d'optimisation
          pour une exploitation fluide en temps réel (GLTF/GLB).
        </p>
